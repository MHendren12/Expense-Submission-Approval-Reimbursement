                ...
                <div class="panel-body">
                    <div class="row" align ="left">
                        ...
                        <div class="col-md-10">
                            <h3>Our Story</h3>
                            <hr>
                            <p>The making of R.A.S.E (Reimbursement and Submission of Expenses)</p>
                            <p>R.A.S.E service was launched, part of Senior Capstone Project class in 2017. In this class, students from various fields such as Computer Science and Information technology brought their skill and creativity into developing great projects that many people may find helpful with their business or daily lives.</p> 
                            ...
                            <h3>Meet the Team</h3><hr>
                                ...
                                <p>
                                    Computer Science Major. College Level: Senior. Contains knowledge in Java, Python, C Programming, HTML,
                                    C#, CSS, Bison, Flex, C++, MySQL, SQL, and PHP.
                                </p>
                                <h4>Shane Kuskowski</h4>
                                <p>
                                    Information Technology Major. College Level: Senior. Contains knowledge in Java, HTML, CSS ...
                                </p> 
                                <h4>Andre Mitchell</h4>
                                <p>
                                    Information Technology Major. College Level: Senior. Contains knowledge in Java, HTML, CSS ...
                                </p>  
                                <h4>Jon Calvert</h4>
                                <p>
                                    Computer Science Major. College Level: Senior. Contains knowledge in Java, HTML, CSS ...
                                </p>  
                                <h4>Matt Papais</h4>
                                <p>
                                    Computer Science Major. College Level: Senior. Contains knowledge in Java, HTML, CSS ...
                                </p>  
                                <h4>Marek Stolarczyk</h4>
                                <p>
                                    Information Technology Major. College Level: Senior. Contains knowledge in Java, HTML, CSS ...
                                </p>  
                        </div>
